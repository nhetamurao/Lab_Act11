...
try {
    ...
    // $router->get('/export-course/{course_code}', '\App\Controllers\CourseController@exportEnrollees'); // New route for PDF export
    $router->get('/export-course/{course_code}', '\App\Controllers\CourseController@exportCourseToPDF');
